...
public class QuarterlyMetricsTaskHist3 extends QuarterlyMetricsTask {
   ...
   */
  public QuarterlyMetricsTaskHist3(int startYear, StockWebPage page, WebAccessor accessor, Set<String> wantedRows,
                                   CfiMenuNavigator menuNavigator) {
    super(page, accessor, wantedRows, menuNavigator);
    _startYear = startYear;
  }

  public QuarterlyMetricsTaskHist3(StockWebPage page, WebAccessor accessor, Set<String> wantedRows,
                                   CfiMenuNavigator menuNavigator) {
